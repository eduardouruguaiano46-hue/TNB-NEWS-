...
export const INITIAL_ARTICLES: Article[] = [
  {
    ...
    content: [
      ...
      'Após a divulgação oficial dos palpites pela comissão organizadora, alguns membros mais fervorosos passaram a interpretar a escolha de Clara como uma falta de apoio direto e patriotismo à Seleção. A situação gerou uma enxurrada de comentários críticos e brincadeiras direcionadas à participante, que foi carinhosamente (e às vezes duramente) rotulada por alguns de "antipatriota" e "traidora dos gramados".',
      'Apesar das reações exacerbadas, uma ala moderada da comunidade rapidamente saiu em defesa da participante. Defensores argumentaram que o bolão consiste apenas em um exercício de previsão, baseado em intuição ou análise fria de estatísticas esportivas, e que escolher determinado placar não significa necessariamente torcer contra o próprio país.',
      'O episódio acabou transcendendo a própria partida esportiva e se tornou o assunto mais debatido e comentado na comunidade durante todo o fim de semana, dividindo opiniões entre a intuição esotérica, a lealdade nacionalista e o espírito de brincadeira.'
    ],
    comments: []
  },
  {
    ...
    content: [
      ...
      'Em seguida, Lucy compartilhou uma experiência onírica hilária e assustadora: contou que sonhou com o próprio atacante gigante norueguês enquanto estava doente e com febre alta em sua cama. Ela descreveu a experiência como "doença e pesadelo misturados em uma coisa só". Para piorar (ou melhorar), compartilhou outro sonho inusitado no qual ela e sua melhor amiga eram contratadas e jogavam futebol de verdade ao lado de Haaland no Manchester City.',
      'Outro alvo das brincadeiras carinhosas foi a colega Dominique, responsável pela divulgação do bolão. Lucy W. Tarot afirmou, rindo, que ficou extremamente impressionada com o empenho implacável de Dominique para promover o bolão do grupo, comparando a abordagem dela ao trabalho daqueles vendedores de passagens que gritam e cercam passageiros em terminais de ônibus urbanos.',
      'Essas mensagens e piadas internas ajudaram a aliviar a tensão da rivalidade esportiva e criaram um ambiente leve, descontraído e de muita união antes da partida oficial.'
    ],
    comments: []
  },
  {
    ...
    content: [
      ...
      'Há alguns meses, Eduardo recebeu seu diagnóstico médico formal de autismo nível 1 de suporte. Para ele e para o grupo, o laudo trouxe uma imensa sensação de alívio e compreensão. Explicou-se que Eduardo utiliza esses áudios como uma verdadeira "muleta social" e terapêutica. Diante da dificuldade natural de interpretar nuances emocionais complexas em tempo real e de verbalizar suas próprias palavras sob pressão, os áudios prontos atuavam como pontes perfeitas de expressão.',
      'Ao entender a realidade do amigo, o grupo TNB realizou um movimento emocionante de acolhimento: criaram um verdadeiro "dicionário afetivo" para catalogar e interpretar as respostas de Eduardo, transformando o estranhamento em um ambiente rico de aprendizado e diversidade.',
      'A tocante jornada de Eduardo serve como um grande exemplo prático sobre a importância de acolher formas atípicas e neurodivergentes de comunicação, provando que a empatia e a conexão humana encontram caminhos onde as palavras tradicionais falham.'
    ],
    technicalSpecs: [
  ...
  },
  {
    ...
    content: [
      ...
      'Coincidência ou não, desde que a prática do ex começou, Viih passou a experimentar uma sensação estranha e persistentente de "puxão" emocional. Ela descreve pensamentos intrusivos e extremamente frequentes sobre ele, coincidências bizarras no dia a dia e uma súbita e inexplicável vontade de procurá-lo, mesmo estando convicta de sua decisão anterior.',
      'Sentindo que seu campo energético estava sendo afetado, Viih resolveu consultar o baralho cigano. Para sua surpresa, as cartas apontaram de forma categórica e nítida uma interferência externa ativa em sua energia vital — uma influência sentimental oculta vinda da oração direcionada.',
...
export const TEAM_MEMBERS = [
  { name: 'Lucy W. Tarot', role: 'Colunista de Humor & Previsões Esportivas' },
  { name: 'Dominique', role: 'Diretora de Eventos e Bolões' },
  { name: 'Viih', role: 'Correspondente de Relacionamentos e Baralho Cigano' },
  { name: 'Eduardo', role: 'Curador de Áudios e Expressões Digitais' },
  { name: 'Simon', role: 'Tarólogo de Plantão & Consultas Sociais' }
];
